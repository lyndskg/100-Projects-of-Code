    ...
    return (function e(a, r, o) {
    ...
    })(
        {
            ...
            3: [
                function (e, a, r) {
                    a.exports = {
                        common: { name: "Common Password: In the top {{ value }} most used passwords", message: "Your password is very commonly used. It would be cracked almost instantly." },
                        xkcd: { name: "xkcd", message: "I suspect the password crackers might be on to this one by now..." },
                        jeff: { name: "There's always a back door...", message: '"The guy who made the software was called Jeff Jeffty Jeff. Born on the first of Jeff, nineteen-jeffty-jeff."' },
                        lengthVeryShort: { name: "Length: Very short", message: "Your password is very short. The longer a password is the more secure it will be." },
                        possiblyWord: {
                        ...
                        onlyNumbers: { name: "Character Variety: Just Numbers", message: "Your password only contains numbers. This reduces the number of possible combinations dramatically." },
                        wordAndNumber: { name: "Possibly a Word and a Number", message: "Your password looks like it might just be a word and a few digits. This is a very common pattern and would be cracked very quickly." },
                        lengthShort: { name: "Length: Short", message: "Your password is quite short. The longer a password is the more secure it will be." },
                        justLetters: { name: "Character Variety: Just Letters", message: "Your password only contains letters. Adding numbers and symbols can make your password more secure." },
                        noSymbols: {
                        ...
                        repeatedPattern: { name: "Repeated Pattern", message: "Repeated characters or patterns can make your password more predictable." },
                        nonStandardCharacters: { name: "Character Variety: Non-Standard Characters", message: "Your password contains a non-keyboard character. This should make it more secure." },
                    ...
                    var o,
                        ...
                        t = function (e) {
                            if (o.hasOwnProperty(e.id)) {
                                var a = o[e.id];
                                return { 
                                    level: e.level, name: e.value ? a.name.replace("{{ value }}",
                                    e.value) : a.name, message: e.value ? a.message.replace("{{ value }}", e.value) : a.message 
                                };
                            }
                    ...
                    var o = function (e) {
                        ...
                        d = o(function (e, a) {
                            ...
                            if (((a = a || []), (e = e || n), s(a))) {
                                ...
                                if (a.hasOwnProperty(r) && !1 === e(a[r], r)) { 
                                    break;
                                }
                            }
                        }),
            ...
            13: [
                function (e, a, r) {
                    ...
                    var o = e("hsimp-library"),
                        n = null,
                        i = { characterSets: e("hsimp-character-sets"), period: e("hsimp-period"), namedNumber: e("hsimp-named-number"), checker: e("hsimp-checker") },
                        ...
                        l = o.memoize(function (e) {
                            ...
                            var y = "bad";
                            return (
                                p.isInsecure() ? ((y = "insecure"), (c = 0), (g = n.instantly)) : c >= t.good ? (y = p.hasWarnings() ? "ok" : "good") : c >= t.ok && (y = "ok"),
                ...
                { "hsimp-character-sets": 2, "hsimp-checker": 4, "hsimp-library": 10, "hsimp-named-number": 15, "hsimp-period": 17 },
            ],
            14: [
                function (e, a, r) {
                    a.exports = {
            ...
            16: [
                function (e, a, r) {
                    a.exports = [
                        ...
                        { singular: "millisecond", plural: "milliseconds", abbreviations: ["ms", "msec"], seconds: 0.001 },
                        { singular: "second", plural: "seconds", abbreviations: ["s", "sec", "secs"], seconds: 1 },
                        { singular: "minute", plural: "minutes", abbreviations: ["m", "min", "mins"], seconds: 60 },
